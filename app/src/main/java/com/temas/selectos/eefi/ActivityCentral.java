...
import static com.temas.selectos.eefi.Notificacion.Canal_1_ID;
import static com.temas.selectos.eefi.Notificacion.Canal_2_ID;
...
public class ActivityCentral extends AppCompatActivity {
    ...
    public void mandarNotificacion1(View view){
        String Titulo = "titulo";
        String Fecha = "fecha";

        Notification notification = new NotificationCompat.Builder(this, Canal_1_ID).setSmallIcon(R.drawable.ic_1).setContentTitle(Titulo).setContentText(Fecha).setPriority(NotificationCompat.PRIORITY_HIGH).setCategory(NotificationCompat.CATEGORY_MESSAGE).build();

        notificationManager.notify(1, notification);
    }

    public void mostrarNotificacion2(View view){
        String Titulo = "titulo";
        String Fecha = "fecha";

        Notification notification = new NotificationCompat.Builder(this, Canal_2_ID).setSmallIcon(R.drawable.ic_2).setContentTitle(Titulo).setContentText(Fecha).setPriority(NotificationCompat.PRIORITY_LOW).build();
